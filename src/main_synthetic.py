...
def main(args):
    ...
    for _ in tqdm(range(args.epochs)):
        epoch_start_time, epoch_acc_train, epoch_acc_val = time.time(), 0, 0
        ...
        epoch_acc_train /= len(train_loader)
        epoch_acc_val /= len(val_loader)
        ...
        wandb.log(
            {
                "Train Accuracy": epoch_acc_train,
                "Validation Accuracy": epoch_acc_val,
